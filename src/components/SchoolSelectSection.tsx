    ...
    <Combobox as="div" value={school?.school} onChange={setSchool}>
      ...
      <div className="relative mt-2">
        <Combobox.Input
          ...
          className="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-12 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 dark:bg-transparent dark:text-slate-200 dark:ring-slate-600 dark:focus:ring-slate-500"
